...
public class VehiculeService {
    ...
    public void delete(Long id) {
        ...
        long nbActives = reservationsActives.stream()
                .filter(r -> {
                    if (r instanceof esiag.back.models.ReservationPlace) {
                        esiag.back.models.ReservationPlace rp = (esiag.back.models.ReservationPlace) r;
                        return rp.getStatut() == esiag.back.models.StatutReservation.CONFIRMEE ||
                               rp.getStatut() == esiag.back.models.StatutReservation.EN_COURS;
                    }
                    return false;
                })
                .count();
