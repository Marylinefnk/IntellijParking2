        ...
        stage('Deploy to VM') {
            steps {
                sshagent(['SshVmBackFrontend']) {
                       ...
                       sh 'scp -o StrictHostKeyChecking=no -r proto-front/public toto@172.31.253.2:/home/toto/projet/proto-front/'
                       sh 'scp -o StrictHostKeyChecking=no -r proto-front/build toto@172.31.253.2:/home/toto/projet/proto-front/'
                       sh 'scp -o StrictHostKeyChecking=no -r proto-front/src toto@172.31.253.2:/home/toto/projet/proto-front/'
                       ...
                       sh 'ssh -o StrictHostKeyChecking=no -f toto@172.31.253.2 "cd /home/toto/projet/proto-back && nohup java -jar proto-back-1.0-SNAPSHOT.jar > backend.log 2>&1 &"'
                       sh 'ssh -o StrictHostKeyChecking=no toto@172.31.253.2 "cd /home/toto/projet/proto-front && nohup npm start > frontend.log 2>&1 &"'
                }
            }
        }
    }
