        ...
        stage('Deploy to VM') {
            steps {
                sshagent(['SshVmBackFrontend']) {
                       ...
                       sh 'ssh -o StrictHostKeyChecking=no -f toto@172.31.249.253 "cd /home/toto/projet/intellijParking-backend && nohup java -jar intellijParking-backend-1.0.0.jar > backend.log 2>&1 &"'
                       sh 'ssh -f -o StrictHostKeyChecking=no toto@172.31.249.253 "nohup /usr/local/bin/serve -s /home/toto/projet/intellijParking-frontend/build -l 3000 > /home/toto/projet/intellijParking-frontend/frontend.log 2>&1 &"'
