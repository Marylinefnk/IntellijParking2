        ...
        stage('Deploy to VM') {
            steps {
                sshagent(['SshVmBackFrontend']) {
                       ...
                       sh 'ssh -o StrictHostKeyChecking=no toto@172.31.253.2 killall serve 2>/dev/null || true'
                       ...
                       sh 'ssh -o StrictHostKeyChecking=no toto@172.31.253.2 "cd /home/toto/projet/proto-front && nohup serve -s . -p 3000 > frontend.log 2>&1 &"'
                }
            }
        }
    }
